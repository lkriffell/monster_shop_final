...
discount = Discount.create!(percent_off: 0.5, min_quantity: 10, merchant_id: megan.id)
discount = Discount.create!(percent_off: 0.5, min_quantity: 5, merchant_id: brian.id)
user = User.create(name: 'Megan', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'user@example.com', password: '1234')
merchant = User.create(name: 'Megan', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'merchant@example.com', password: '1234', role:1, merchant: megan)
